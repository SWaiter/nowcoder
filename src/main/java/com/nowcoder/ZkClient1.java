...
public class ZkClient1 {
    ...
    public static final Logger logger = LoggerFactory.getLogger(ZkClient1.class);
    ...
    public static ZkClient1 zkClient;
    ...
    public List<String> getUrl(String u) throws ParseException {
        ...
        Date n = dateFormat.parse("2018-10-01_00-00-00");
